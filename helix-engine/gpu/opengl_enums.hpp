// This file was automatically generated by the .NET program Sophie.BindGen.
// Generated: 11/20/2025 18:41:47

#ifndef Include_Guard_Sophie_Graphics_Loader
#define Include_Guard_Sophie_Graphics_Loader 1

/* Configure what calling convention must be used to obtain the correct function pointer from the driver. */
#if defined(_WIN32) && !defined(_Sgl_Call_Cv_) && !defined(__CYGWIN__) && !defined(__SCITECH_SNAP__) // OS=Windows,NOT Cygwin, NOT SciTech
#define SGL_CallingConvention __stdcall
#endif

#include "glad/KHR/khrplatform.h"

#if !defined(SGL_CallingConvention) /* Fallback calling convention */
#define SGL_CallingConvention
#endif /* !SGL_CallingConvention */

#ifndef SGL_SignatureQualifiers
#define SGL_SignatureQualifiers SGL_CallingConvention*
#endif /* !SGL_SignatureQualifiers */

#ifndef SGL_Qualifiers
#define SGL_Qualifiers extern
#endif /* !SGL_Qualifiers */
...
typedef void ( *GLDEBUGPROC)(GLenum source,GLenum type,GLuint id,GLenum severity,GLsizei length, GLchar const *message, void const *userParam);
typedef void ( *GLDEBUGPROCARB)(GLenum source,GLenum type,GLuint id,GLenum severity,GLsizei length, GLchar const *message, void const *userParam);
typedef void ( *GLDEBUGPROCKHR)(GLenum source,GLenum type,GLuint id,GLenum severity,GLsizei length, GLchar const *message, void const *userParam);
typedef void ( *GLDEBUGPROCAMD)(GLuint id,GLenum category,GLenum severity,GLsizei length, GLchar const *message,void *userParam);
typedef unsigned short GLhalfNV;
typedef GLintptr GLvdpauSurfaceNV;
typedef void ( *GLVULKANPROCNV)(void);
namespace gl {

	/* Necessary Definitions from the OpenGL Standard. */
	...
	using clampx_t = GLclampx;
	using sizei_t = GLsizei;
	using float32_t = GLfloat;
	using clampf_t = GLclampf;
	using float64_t = GLdouble;
	using clampd_t = GLclampd;
	using char_t = GLchar;
	using charARB_t = GLcharARB;
	using handleARB_t = GLhandleARB;
	using half_t = GLhalf;
	using halfARB_t = GLhalfARB;
	using fixed_t = GLfixed;
	using intptr_t = GLintptr;
	using intptrARB_t = GLintptrARB;
	using sizeiptr_t = GLsizeiptr;
	using sizeiptrARB_t = GLsizeiptrARB;
	using int64_t = GLint64;
	using int64EXT_t = GLint64EXT;
	using uint64_t = GLuint64;
	using uint64EXT_t = GLuint64EXT;
	using halfNV_t = GLhalfNV;
	using vdpauSurfaceNV_t = GLvdpauSurfaceNV;
	/* SGL functionality  */

	enum class AttribMask : gl::enum_t {
		...
		/* Guaranteed to mark all attribute groups at once */ AllAttribBits = 0xFFFFFFFF
	};
/// <summary>
/// GL_{DEPTH,ACCUM,STENCIL,COLOR}_BUFFER_BIT also lie in this namespace
/// </summary>

	enum class ClearBufferMask : gl::uint16_t {
		DepthBufferBit = 0x00000100,
		AccumBufferBit = 0x00000200,
		StencilBufferBit = 0x00000400,
		ColorBufferBit = 0x00004000,
		/* Collides with AttribMask bit GL_HINT_BIT. OK since this token is for OpenGL ES 2, which doesn't have attribute groups. */ CoverageBufferBitNv = 0x00008000
	};
	constexpr char const *to_string(ClearBufferMask const e) {
		switch (e) {
			...
			case ClearBufferMask::CoverageBufferBitNv: return "CoverageBufferBitNv";
		}
		return "unknown";
	}
/// <summary>
...
/// </summary>
	...
	enum class BufferStorageMask : gl::enum_t {
...
/// </summary>
	...
	enum class ContextFlagMask : gl::enum_t {
	...
	enum class ContextProfileMask : gl::enum_t {
		ContextCoreProfileBit = 0x00000001, 
		ContextCompatibilityProfileBit = 0x00000002
	};
	enum class MapBufferAccessMask : gl::enum_t {
		MapReadBit = 0x0001, 
		MapReadBitExt = 0x0001, 
		MapWriteBit = 0x0002, 
		MapWriteBitExt = 0x0002, 
	...
	enum class OcclusionQueryEventMaskAMD : gl::enum_t {
	...
	enum class SyncObjectMask : gl::enum_t {
		SyncFlushCommandsBit = 0x00000001, 
		SyncFlushCommandsBitApple = 0x00000001
	};
	enum class UseProgramStageMask : gl::enum_t {
	...
	enum class SubgroupSupportedFeatures : gl::uint16_t {
	...
	enum class TextureStorageMaskAMD : gl::ubyte_t {
		TextureStorageSparseBitAmd = 0x00000001
	};
	enum class FragmentShaderDestMaskATI : gl::ubyte_t {
		RedBitAti = 0x00000001, 
		GreenBitAti = 0x00000002, 
		BlueBitAti = 0x00000004, 
		None = 0
	};
	enum class FragmentShaderDestModMaskATI : gl::ubyte_t {
	...
	enum class FragmentShaderColorModMaskATI : gl::ubyte_t {
		_2XBitAti = 0x00000001, 
		CompBitAti = 0x00000002, 
		NegateBitAti = 0x00000004, 
		BiasBitAti = 0x00000008
	};
	enum class TraceMaskMESA : gl::uint16_t {
	...
	enum class PathFontStyle : gl::uint64_t {
		BoldBitNv = 0x01, 
		ItalicBitNv = 0x02, 
		None = 0
	};
	enum class PathMetricMask : gl::uint64_t {
	...
	enum class PerformanceQueryCapsMaskINTEL : gl::enum_t {
		PerfquerySingleContextIntel = 0x00000000, 
		PerfqueryGlobalContextIntel = 0x00000001
	};
	enum class VertexHintsMaskPGI : gl::enum_t {
	...
	enum class BufferBitQCOM : gl::enum_t {
	...
	enum class FoveationConfigBitQCOM : gl::ubyte_t {
	...
	enum class FfdMaskSGIX : gl::enum_t {
...
/// </summary>
	...
	enum class CommandOpcodesNV : gl::enum_t {
...
/// </summary>
	...
	enum class MapTextureFormatINTEL : gl::enum_t {
		LayoutDefaultIntel = 0, 
		LayoutLinearIntel = 1, 
		LayoutLinearCpuCachedIntel = 2
	};
	enum class PathCoordType : gl::uint64_t {
		ClosePathNv = 0x00, 
		MoveToNv = 0x02, 
	...
	enum class All : gl::uint64_t {
		...
		/* For the OpenGL ES version of EXT_separate_shader_objects */ ActiveProgramExt = 0x8259, 
		...
		/* Reserved for future */ RobustGpuTimeoutMsKhr = 0x82FD, 
		...
		/* NOT an alias. Accidental reuse of GL_MAP2_VERTEX_ATTRIB7_4_NV */ ProgramBindingArb = 0x8677, 
		...
		Dot3RgbExt = 0x8740, 
		/* NOT an alias. Accidental reuse of GL_DOT3_RGB_EXT */ Z400BinaryAmd = 0x8740, 
		Dot3RgbaExt = 0x8741, 
		/* NOT an alias. Accidental reuse of GL_DOT3_RGBA_EXT */ ProgramBinaryLengthOes = 0x8741, 
		...
		/* NOT an alias. Accidental reuse of GL_TEXTURE_1D_STACK_MESAX */ DebugObjectMesa = 0x8759, 
		Texture1DStackMesax = 0x8759, 
		/* NOT an alias. Accidental reuse of GL_TEXTURE_2D_STACK_MESAX */ DebugPrintMesa = 0x875A, 
		Texture2DStackMesax = 0x875A, 
		/* NOT an alias. Accidental reuse of GL_PROXY_TEXTURE_1D_STACK_MESAX */ DebugAssertMesa = 0x875B, 
		...
		/* Defined by Mesa but not ATI */ CompressedLuminanceAlpha3DcAti = 0x8837, 
		...
		/* For the OpenGL version of EXT_separate_shader_objects */ // ActiveProgramExt = 0x8B8D, 
		...
		/* Equivalent to GL_TEXTURE_BUFFER_ARB query, but named more consistently */ TextureBufferBinding = 0x8C2A, 
		...
		/* From the WEBGL_debug_renderer_info extension */ UnmaskedVendorWebgl = 0x9245, 
		/* From the WEBGL_debug_renderer_info extension */ UnmaskedRendererWebgl = 0x9246, 
		MaxClientWaitTimeoutWebgl = 0x9247, 
		/* From the WEBGL_video_texture extension */ TextureVideoImageWebgl = 0x9248, 
		/* From the WEBGL_video_texture extension */ SamplerVideoImageWebgl = 0x9249, 
...
/// </summary>
	...
	enum class TransformFeedbackTokenNV : gl::int32_t {
		NextBufferNv = -2, 
		SkipComponents4Nv = -3, 
		SkipComponents3Nv = -4, 
		SkipComponents2Nv = -5, 
...
/// <summary>
/// 
/// <vendor>Sun Microsystems, Inc. (SUN)</vendor>
/// </summary>

	enum class TriangleListSUN : gl::byte_t {
		RestartSun = 0x0001, 
...
/// </summary>
	...
	enum class SpecialNumbers : gl::uint64_t {
		False = 0, 
		NoError = 0, 
		Zero = 0, 
		None = 0, 
		...
		True = 1, 
		One = 1, 
		/* Tagged as uint */ InvalidIndex = 0xFFFFFFFF, 
		AllPixelsAmd = 0xFFFFFFFF, 
		/* Tagged as uint64 */ TimeoutIgnored = 0xFFFFFFFFFFFFFFFF, 
		/* Tagged as uint64 */ TimeoutIgnoredApple = 0xFFFFFFFFFFFFFFFF, 
		/* Not an API enum. API definition macro for ES 1.0/1.1 headers */ VersionEsCl10 = 1, 
		/* Not an API enum. API definition macro for ES 1.0/1.1 headers */ VersionEsCm11 = 1, 
		/* Not an API enum. API definition macro for ES 1.0/1.1 headers */ VersionEsCl11 = 1, 
		UuidSizeExt = 16, 
		LuidSizeExt = 8
	};
	enum class Boolean : gl::byte_t {
		False = 0, 
		True = 1
	};
	enum class VertexShaderWriteMaskEXT : gl::byte_t {
		False = 0, 
		True = 1
	};
	enum class ClampColorModeARB : gl::enum_t {
		False = 0, 
		True = 1, 
		FixedOnly = 0x891D, 
		FixedOnlyArb = 0x891D
	...
	enum class StencilOp : gl::enum_t {
		Zero = 0, 
		Invert = 0x150A, 
		Keep = 0x1E00, 
		Replace = 0x1E01, 
	...
	enum class BlendingFactor : gl::enum_t {
		Zero = 0, 
		One = 1, 
		SrcColor = 0x0300, 
	...
	enum class FragmentShaderGenericSourceATI : gl::enum_t {
		Zero = 0, 
		One = 1, 
		PrimaryColor = 0x8577, 
	...
	enum class FragmentShaderValueRepATI : gl::enum_t {
		None = 0, 
		Red = 0x1903, 
		Green = 0x1904, 
		Blue = 0x1905, 
	...
	enum class SyncBehaviorFlags : gl::enum_t {
		None = 0
	};
	enum class TextureCompareMode : gl::enum_t {
		None = 0, 
		CompareRToTexture = 0x884E, 
		CompareRefToTexture = 0x884E
	};
	enum class PathColorFormat : gl::enum_t {
		None = 0, 
		Alpha = 0x1906, 
		Rgb = 0x1907, 
		Rgba = 0x1908, 
	...
	enum class CombinerBiasNV : gl::enum_t {
		None = 0, 
		BiasByNegativeOneHalfNv = 0x8541
	};
	enum class CombinerScaleNV : gl::enum_t {
		None = 0, 
		ScaleByTwoNv = 0x853E, 
		ScaleByFourNv = 0x853F, 
		ScaleByOneHalfNv = 0x8540
	};
	enum class DrawBufferMode : gl::enum_t {
		None = 0, 
		NoneOes = 0, 
		FrontLeft = 0x0400, 
		FrontRight = 0x0401, 
	...
	enum class PixelTexGenModeSGIX : gl::enum_t {
		None = 0, 
		Alpha = 0x1906, 
		Rgb = 0x1907, 
		Rgba = 0x1908, 
	...
	enum class ReadBufferMode : gl::enum_t {
		None = 0, 
		NoneOes = 0, 
		FrontLeft = 0x0400, 
		FrontRight = 0x0401, 
	...
	enum class ColorBuffer : gl::enum_t {
		None = 0, 
		FrontLeft = 0x0400, 
		FrontRight = 0x0401, 
		BackLeft = 0x0402, 
	...
	enum class PathGenMode : gl::enum_t {
		None = 0, 
		EyeLinear = 0x2400, 
		ObjectLinear = 0x2401, 
		Constant = 0x8576, 
	...
	enum class PathTransformType : gl::enum_t {
		None = 0, 
		TranslateXNv = 0x908E, 
		TranslateYNv = 0x908F, 
	...
	enum class PrimitiveType : gl::enum_t {
		Points = 0x0000, 
		Lines = 0x0001, 
		LineLoop = 0x0002, 
		LineStrip = 0x0003, 
	...
	enum class TextureEnvMode : gl::enum_t {
		Add = 0x0104, 
		Blend = 0x0BE2, 
		Replace = 0x1E01, 
		Modulate = 0x2100, 
	...
	enum class LightEnvModeSGIX : gl::enum_t {
		Add = 0x0104, 
		Replace = 0x1E01, 
		Modulate = 0x2100
	};
	...
	enum class IndexFunctionEXT : gl::enum_t {
		Never = 0x0200, 
		Less = 0x0201, 
		Equal = 0x0202, 
		Lequal = 0x0203, 
	...
	enum class AlphaFunction : gl::enum_t {
		Never = 0x0200, 
		Less = 0x0201, 
		Equal = 0x0202, 
		Lequal = 0x0203, 
	...
	enum class TriangleFace : gl::enum_t {
		Front = 0x0404, 
		Back = 0x0405, 
		FrontAndBack = 0x0408
	};
	enum class FeedbackType : gl::enum_t {
		_2D = 0x0600, 
		_3D = 0x0601, 
		_3DColor = 0x0602, 
	...
	enum class FeedBackToken : gl::enum_t {
	...
	enum class FogMode : gl::enum_t {
		Exp = 0x0800, 
		Exp2 = 0x0801, 
		Linear = 0x2601, 
		FogFuncSgis = 0x812A
	};
	enum class FrontFaceDirection : gl::enum_t {
		Cw = 0x0900, 
		Ccw = 0x0901
	};
	enum class MapQuery : gl::enum_t {
		Coeff = 0x0A00, 
		Order = 0x0A01, 
		Domain = 0x0A02
	};
	enum class GetMapQuery : gl::enum_t {
		Coeff = 0x0A00, 
		Order = 0x0A01, 
		Domain = 0x0A02
	};
	enum class GetPName : gl::enum_t {
		CurrentColor = 0x0B00, 
		CurrentIndex = 0x0B01, 
		...
		/* Formerly 0x842C in SGI specfile */ PackResampleSgix = 0x842E, 
		/* Formerly 0x842D in SGI specfile */ UnpackResampleSgix = 0x842F, 
	...
	enum class VertexShaderTextureUnitParameter : gl::enum_t {
		CurrentTextureCoords = 0x0B03, 
		TextureMatrix = 0x0BA8
	};
	enum class EnableCap : gl::enum_t {
		PointSmooth = 0x0B10, 
		LineSmooth = 0x0B20, 
		LineStipple = 0x0B24, 
		PolygonSmooth = 0x0B41, 
	...
	enum class LightModelParameter : gl::enum_t {
		LightModelLocalViewer = 0x0B51, 
		LightModelTwoSide = 0x0B52, 
		LightModelAmbient = 0x0B53, 
		LightModelColorControl = 0x81F8, 
	...
	enum class FogParameter : gl::enum_t {
		FogIndex = 0x0B61, 
		FogDensity = 0x0B62, 
		FogStart = 0x0B63, 
		FogEnd = 0x0B64, 
	...
	enum class GetFramebufferParameter : gl::enum_t {
		Doublebuffer = 0x0C32, 
		Stereo = 0x0C33, 
		SampleBuffers = 0x80A8, 
		Samples = 0x80A9, 
	...
	enum class HintTarget : gl::enum_t {
		PerspectiveCorrectionHint = 0x0C50, 
		PointSmoothHint = 0x0C51, 
		LineSmoothHint = 0x0C52, 
		PolygonSmoothHint = 0x0C53, 
	...
	enum class PixelStoreParameter : gl::enum_t {
		UnpackSwapBytes = 0x0CF0, 
		UnpackLsbFirst = 0x0CF1, 
		UnpackRowLength = 0x0CF2, 
	...
	enum class PixelTransferParameter : gl::enum_t {
		MapColor = 0x0D10, 
		MapStencil = 0x0D11, 
		IndexShift = 0x0D12, 
		IndexOffset = 0x0D13, 
	...
	enum class IndexMaterialParameterEXT : gl::enum_t {
		IndexOffset = 0x0D13
	};
/// <summary>
/// 
/// <vendor>AMD/NV</vendor>
/// </summary>

	enum class TextureEnvParameter : gl::enum_t {
		AlphaScale = 0x0D1C, 
	...
	enum class MapTarget : gl::enum_t {
		Map1Color4 = 0x0D90, 
		Map1Index = 0x0D91, 
		Map1Normal = 0x0D92, 
		Map1TextureCoord1 = 0x0D93, 
	...
	enum class CopyImageSubDataTarget : gl::enum_t {
		Texture1D = 0x0DE0, 
		Texture2D = 0x0DE1, 
		Texture3D = 0x806F, 
		TextureRectangle = 0x84F5, 
	...
	enum class TextureTarget : gl::enum_t {
		Texture1D = 0x0DE0, 
		Texture2D = 0x0DE1, 
	...
	enum class GetPointervPName : gl::enum_t {
	...
	enum class TextureParameterName : gl::uint16_t {
		TextureWidth = 0x1000, 
	...
	enum class GetTextureParameter : gl::uint16_t {
		TextureWidth = 0x1000, 
		TextureHeight = 0x1001, 
		TextureInternalFormat = 0x1003, 
		TextureComponents = 0x1003, 
	...
	enum class SamplerParameterF : gl::enum_t {
		TextureBorderColor = 0x1004, 
		TextureMinLod = 0x813A, 
		TextureMaxLod = 0x813B, 
		TextureMaxAnisotropy = 0x84FE, 
	...
	enum class DebugSeverity : gl::enum_t {
		DontCare = 0x1100, 
	...
	enum class MaterialParameter : gl::enum_t {
		Ambient = 0x1200, 
		Diffuse = 0x1201, 
		Specular = 0x1202, 
		Emission = 0x1600, 
	...
	enum class FragmentLightParameterSGIX : gl::enum_t {
		Ambient = 0x1200, 
		Diffuse = 0x1201, 
		Specular = 0x1202, 
		Position = 0x1203, 
	...
	enum class ColorMaterialParameter : gl::enum_t {
		Ambient = 0x1200, 
		Diffuse = 0x1201, 
		Specular = 0x1202, 
		Emission = 0x1600, 
	...
	enum class ListMode : gl::enum_t {
		Compile = 0x1300, 
		CompileAndExecute = 0x1301
	};
	enum class VertexAttribIType : gl::enum_t {
		Byte = 0x1400, 
		UnsignedByte = 0x1401, 
		Short = 0x1402, 
	...
	enum class WeightPointerTypeARB : gl::enum_t {
		Byte = 0x1400, 
		UnsignedByte = 0x1401, 
		Short = 0x1402, 
		UnsignedShort = 0x1403, 
	...
	enum class TangentPointerTypeEXT : gl::enum_t {
		Byte = 0x1400, 
		Short = 0x1402, 
		Int = 0x1404, 
		Float = 0x1406, 
	...
	enum class BinormalPointerTypeEXT : gl::enum_t {
		Byte = 0x1400, 
		Short = 0x1402, 
		Int = 0x1404, 
		Float = 0x1406, 
	...
	enum class ColorPointerType : gl::enum_t {
		Byte = 0x1400, 
		UnsignedByte = 0x1401, 
		Short = 0x1402, 
		UnsignedShort = 0x1403, 
	...
	enum class ListNameType : gl::enum_t {
		Byte = 0x1400, 
		UnsignedByte = 0x1401, 
		Short = 0x1402, 
		UnsignedShort = 0x1403, 
	...
	enum class NormalPointerType : gl::enum_t {
		Byte = 0x1400, 
		Short = 0x1402, 
		Int = 0x1404, 
		Float = 0x1406, 
	...
	enum class PixelType : gl::enum_t {
		Byte = 0x1400, 
		UnsignedByte = 0x1401, 
		Short = 0x1402, 
		UnsignedShort = 0x1403, 
	...
	enum class VertexAttribType : gl::enum_t {
		Byte = 0x1400, 
		UnsignedByte = 0x1401, 
		Short = 0x1402, 
		UnsignedShort = 0x1403, 
	...
	enum class VertexAttribPointerType : gl::enum_t {
		Byte = 0x1400, 
		UnsignedByte = 0x1401, 
		Short = 0x1402, 
		UnsignedShort = 0x1403, 
	...
	enum class ScalarType : gl::enum_t {
		UnsignedByte = 0x1401, 
		UnsignedShort = 0x1403, 
		UnsignedInt = 0x1405
	};
	enum class ReplacementCodeTypeSUN : gl::enum_t {
		UnsignedByte = 0x1401, 
		UnsignedShort = 0x1403, 
		UnsignedInt = 0x1405
	};
	enum class ElementPointerTypeATI : gl::enum_t {
		UnsignedByte = 0x1401, 
		UnsignedShort = 0x1403, 
		UnsignedInt = 0x1405
	};
	enum class MatrixIndexPointerTypeARB : gl::enum_t {
		UnsignedByte = 0x1401, 
		UnsignedShort = 0x1403, 
		UnsignedInt = 0x1405
	};
	enum class DrawElementsType : gl::enum_t {
		UnsignedByte = 0x1401, 
		UnsignedShort = 0x1403, 
		UnsignedInt = 0x1405
	};
	enum class SecondaryColorPointerTypeIBM : gl::enum_t {
		Short = 0x1402, 
		Int = 0x1404, 
		Float = 0x1406, 
		Double = 0x140A
	};
	enum class IndexPointerType : gl::enum_t {
		Short = 0x1402, 
		Int = 0x1404, 
		Float = 0x1406, 
		Double = 0x140A
	};
	enum class TexCoordPointerType : gl::enum_t {
		Short = 0x1402, 
		Int = 0x1404, 
		Float = 0x1406, 
		Double = 0x140A
	};
	enum class VertexPointerType : gl::enum_t {
		Short = 0x1402, 
		Int = 0x1404, 
		Float = 0x1406, 
		Double = 0x140A
	};
	enum class PixelFormat : gl::enum_t {
		UnsignedShort = 0x1403, 
		UnsignedInt = 0x1405, 
		ColorIndex = 0x1900, 
		StencilIndex = 0x1901, 
...
/// </summary>
	...
	enum class AttributeType : gl::enum_t {
		Int = 0x1404, 
		UnsignedInt = 0x1405, 
		Float = 0x1406, 
		Double = 0x140A, 
	...
	enum class UniformType : gl::enum_t {
		Int = 0x1404, 
		UnsignedInt = 0x1405, 
		Float = 0x1406, 
		Double = 0x140A, 
	...
	enum class MapTypeNV : gl::enum_t {
		Float = 0x1406, 
		Double = 0x140A
	};
	enum class VertexWeightPointerTypeEXT : gl::enum_t {
		Float = 0x1406
	};
	enum class FogCoordinatePointerType : gl::enum_t {
		Float = 0x1406, 
		Double = 0x140A
	};
	enum class FogPointerTypeEXT : gl::enum_t {
		Float = 0x1406, 
		Double = 0x140A
	};
	enum class FogPointerTypeIBM : gl::enum_t {
		Float = 0x1406, 
		Double = 0x140A
	};
	enum class VertexAttribLType : gl::enum_t {
		Double = 0x140A
	};
	enum class LogicOp : gl::enum_t {
		Clear = 0x1500, 
		And = 0x1501, 
		AndReverse = 0x1502, 
		Copy = 0x1503, 
	...
	enum class PathFillMode : gl::enum_t {
		Invert = 0x150A, 
		PathFillModeNv = 0x9080, 
		CountUpNv = 0x9088, 
		CountDownNv = 0x9089
	};
	enum class MatrixMode : gl::enum_t {
		ModelView = 0x1700, 
		ModelView0Ext = 0x1700, 
		Projection = 0x1701, 
		Texture = 0x1702
	};
	enum class ObjectIdentifier : gl::enum_t {
		Texture = 0x1702, 
		VertexArray = 0x8074, 
		Buffer = 0x82E0, 
		Shader = 0x82E1, 
	...
	enum class PixelCopyType : gl::enum_t {
		Color = 0x1800, 
		ColorExt = 0x1800, 
		Depth = 0x1801, 
		DepthExt = 0x1801, 
	...
	enum class InvalidateFramebufferAttachment : gl::enum_t {
		Color = 0x1800, 
		Depth = 0x1801, 
		Stencil = 0x1802, 
	...
	enum class InternalFormat : gl::enum_t {
		StencilIndex = 0x1901,
	...
	constexpr char const *to_string(InternalFormat const e) {
		switch (e) {
			...
			case InternalFormat::CompressedRgbaS3tcDxt3Ext: return "CompressedRgbaS3tcDxt3Ext";
			case InternalFormat::CompressedRgbaS3tcDxt5Ext: return "CompressedRgbaS3tcDxt5Ext";
			...
			case InternalFormat::Rgb565: return "Rgb565";
			...
			case InternalFormat::CompressedRgRgtc2: return "CompressedRgRgtc2";
			case InternalFormat::CompressedSignedRgRgtc2: return "CompressedSignedRgRgtc2";
	...
	enum class DepthStencilTextureMode : gl::enum_t {
		StencilIndex = 0x1901, 
		DepthComponent = 0x1902
	};
	enum class CombinerComponentUsageNV : gl::enum_t {
		Blue = 0x1905, 
		Alpha = 0x1906, 
		Rgb = 0x1907
	};
	enum class CombinerPortionNV : gl::enum_t {
		Alpha = 0x1906, 
		Rgb = 0x1907
	};
	enum class PolygonMode : gl::enum_t {
		Point = 0x1B00, 
		Line = 0x1B01, 
		Fill = 0x1B02
	};
	enum class MeshMode1 : gl::enum_t {
		Point = 0x1B00, 
		Line = 0x1B01
	};
	enum class MeshMode2 : gl::enum_t {
		Point = 0x1B00, 
		Line = 0x1B01, 
		Fill = 0x1B02
	};
	enum class EvalMapsModeNV : gl::enum_t {
		FillNv = 0x1B02
	};
	enum class RenderingMode : gl::enum_t {
		Render = 0x1C00, 
		Feedback = 0x1C01, 
		Select = 0x1C02
	};
	enum class ShadingModel : gl::enum_t {
		Flat = 0x1D00, 
		Smooth = 0x1D01
	};
	enum class StringName : gl::enum_t {
		Vendor = 0x1F00, 
		Renderer = 0x1F01, 
		Version = 0x1F02, 
		Extensions = 0x1F03, 
	...
	enum class TextureCoordName : gl::enum_t {
		S = 0x2000, 
		T = 0x2001, 
		R = 0x2002, 
		Q = 0x2003, 
	...
	enum class TextureEnvTarget : gl::enum_t {
		TextureEnv = 0x2300, 
		TextureFilterControl = 0x8500, 
		PointSprite = 0x8861
	};
	enum class TextureGenMode : gl::enum_t {
		EyeLinear = 0x2400, 
		ObjectLinear = 0x2401, 
		SphereMap = 0x2402, 
	...
	enum class TextureGenParameter : gl::enum_t {
	...
	enum class BlitFramebufferFilter : gl::enum_t {
		Nearest = 0x2600, 
		Linear = 0x2601
	};
	...
	enum class TextureMinFilter : gl::enum_t {
		Nearest = 0x2600, 
		Linear = 0x2601, 
	...
	enum class SamplerParameterI : gl::enum_t {
		TextureMagFilter = 0x2800, 
		TextureMinFilter = 0x2801, 
		TextureWrapS = 0x2802, 
		TextureWrapT = 0x2803, 
	...
	enum class TextureWrapMode : gl::enum_t {
		Clamp = 0x2900, 
		Repeat = 0x2901, 
	...
	enum class SizedInternalFormat : gl::enum_t {
		R3G3B2 = 0x2A10, 
		Alpha4 = 0x803B, 
		Alpha4Ext = 0x803B, 
		Alpha8 = 0x803C, 
	...
	enum class InterleavedArrayFormat : gl::enum_t {
		V2f = 0x2A20, 
		V3f = 0x2A21, 
		C4ubV2f = 0x2A22, 
		C4ubV3f = 0x2A23, 
	...
	enum class ClipPlaneName : gl::enum_t {
		ClipPlane0 = 0x3000, 
		ClipDistance0 = 0x3000, 
		ClipPlane1 = 0x3001, 
		ClipDistance1 = 0x3001, 
	...
	enum class LightName : gl::enum_t {
		Light0 = 0x4000, 
		Light1 = 0x4001, 
		Light2 = 0x4002, 
		Light3 = 0x4003, 
	...
	enum class BlendEquationModeEXT : gl::enum_t {
		FuncAdd = 0x8006, 
		FuncAddExt = 0x8006, 
		Min = 0x8007, 
		MinExt = 0x8007, 
	...
	enum class ConvolutionTarget : gl::enum_t {
		Convolution1D = 0x8010, 
		Convolution2D = 0x8011
	};
	enum class ConvolutionTargetEXT : gl::enum_t {
		Convolution1D = 0x8010, 
		Convolution1DExt = 0x8010, 
		Convolution2D = 0x8011, 
		Convolution2DExt = 0x8011
	};
	enum class SeparableTarget : gl::enum_t {
		Separable2D = 0x8012
	};
	enum class SeparableTargetEXT : gl::enum_t {
		Separable2D = 0x8012, 
		Separable2DExt = 0x8012
	};
	enum class ConvolutionParameter : gl::enum_t {
	...
	enum class ConvolutionBorderModeEXT : gl::enum_t {
		Reduce = 0x8016, 
		ReduceExt = 0x8016
	};
	enum class HistogramTarget : gl::enum_t {
		Histogram = 0x8024, 
		ProxyHistogram = 0x8025
	};
	enum class HistogramTargetEXT : gl::enum_t {
		Histogram = 0x8024, 
		HistogramExt = 0x8024, 
		ProxyHistogram = 0x8025, 
		ProxyHistogramExt = 0x8025
	};
	enum class GetHistogramParameterPNameEXT : gl::enum_t {
	...
	enum class MinmaxTarget : gl::enum_t {
		Minmax = 0x802E
	};
	enum class MinmaxTargetEXT : gl::enum_t {
		Minmax = 0x802E, 
		MinmaxExt = 0x802E
	};
	enum class GetMinmaxParameterPNameEXT : gl::enum_t {
		MinmaxFormat = 0x802F, 
		MinmaxFormatExt = 0x802F, 
		MinmaxSink = 0x8030, 
		MinmaxSinkExt = 0x8030
	};
	enum class SamplePatternSGIS : gl::enum_t {
		_1PassExt = 0x80A1, 
		_1PassSgis = 0x80A1, 
		_2Pass0Ext = 0x80A2, 
		_2Pass0Sgis = 0x80A2, 
	...
	enum class SamplePatternEXT : gl::enum_t {
		_1PassExt = 0x80A1, 
		_2Pass0Ext = 0x80A2, 
		_2Pass1Ext = 0x80A3, 
		_4Pass0Ext = 0x80A4, 
	...
	enum class InternalFormatPName : gl::enum_t {
		Samples = 0x80A9, 
		GenerateMipmap = 0x8191, 
		...
		Mipmap = 0x8293, 
		/* Should be deprecated */ AutoGenerateMipmap = 0x8295, 
	...
	enum class ColorTableTargetSGI : gl::enum_t {
		TextureColorTableSgi = 0x80BC, 
	...
	enum class ColorTableTarget : gl::enum_t {
		ColorTable = 0x80D0, 
		PostConvolutionColorTable = 0x80D1, 
		PostColorMatrixColorTable = 0x80D2, 
		ProxyColorTable = 0x80D3, 
	...
	enum class ColorTableParameterPName : gl::enum_t {
	...
	enum class BufferTargetARB : gl::enum_t {
	...
	enum class PointParameterNameARB : gl::enum_t {
		PointSizeMin = 0x8126, 
		PointSizeMinArb = 0x8126, 
		PointSizeMinExt = 0x8126, 
		PointSizeMinSgis = 0x8126, 
	...
	enum class TextureFilterSGIS : gl::enum_t {
		Filter4Sgis = 0x8146
	};
	enum class SpriteParameterNameSGIX : gl::enum_t {
		SpriteModeSgix = 0x8149
	};
	enum class SpriteModeSGIX : gl::enum_t {
		SpriteAxialSgix = 0x814C, 
		SpriteObjectAlignedSgix = 0x814D, 
		SpriteEyeAlignedSgix = 0x814E
	};
	enum class ImageTransformPNameHP : gl::enum_t {
	...
	enum class ImageTransformTargetHP : gl::enum_t {
		ImageTransform2DHp = 0x8161
	};
	enum class ListParameterName : gl::enum_t {
		ListPrioritySgix = 0x8182
	};
	enum class FfdTargetSGIX : gl::enum_t {
		GeometryDeformationSgix = 0x8194, 
		TextureDeformationSgix = 0x8195
	};
	enum class CullParameterEXT : gl::enum_t {
		CullVertexEyePositionExt = 0x81AB, 
		CullVertexObjectPositionExt = 0x81AC
	};
	enum class LightModelColorControl : gl::enum_t {
		SingleColor = 0x81F9, 
		SingleColorExt = 0x81F9, 
		SeparateSpecularColor = 0x81FA, 
		SeparateSpecularColorExt = 0x81FA
	};
	enum class ProgramTarget : gl::enum_t {
	...
	enum class FramebufferAttachmentParameterName : gl::enum_t {
	...
	enum class BufferPNameARB : gl::enum_t {
	...
	enum class ProgramParameterPName : gl::enum_t {
		ProgramBinaryRetrievableHint = 0x8257, 
		ProgramSeparable = 0x8258
	};
	enum class PipelineParameterName : gl::enum_t {
	...
	enum class ProgramPropertyARB : gl::enum_t {
	...
	enum class VertexAttribPropertyARB : gl::enum_t {
	...
	enum class VertexArrayPName : gl::enum_t {
		VertexAttribRelativeOffset = 0x82D5, 
		VertexAttribArrayEnabled = 0x8622, 
		VertexAttribArraySize = 0x8623, 
		VertexAttribArrayStride = 0x8624, 
	...
	enum class QueryObjectParameterName : gl::enum_t {
		QueryTarget = 0x82EA, 
		QueryResult = 0x8866, 
		QueryResultAvailable = 0x8867, 
		QueryResultNoWait = 0x9194
	};
	enum class QueryTarget : gl::enum_t {
	...
	enum class PixelTransformTargetEXT : gl::enum_t {
		PixelTransform2DExt = 0x8330
	};
	enum class PixelTransformPNameEXT : gl::enum_t {
		PixelMagFilterExt = 0x8331, 
		PixelMinFilterExt = 0x8332, 
		PixelCubicWeightExt = 0x8333
	};
	enum class LightTextureModeEXT : gl::enum_t {
	...
	enum class LightTexturePNameEXT : gl::enum_t {
		AttenuationExt = 0x834D, 
		ShadowAttenuationExt = 0x834E
	};
	enum class PixelTexGenParameterNameSGIS : gl::enum_t {
		PixelFragmentRgbSourceSgis = 0x8354, 
		PixelFragmentAlphaSourceSgis = 0x8355
	};
	enum class PerfQueryDataFlags : gl::enum_t {
		PerfqueryDonotFlushIntel = 0x83F9, 
		PerfqueryFlushIntel = 0x83FA, 
		PerfqueryWaitIntel = 0x83FB
	};
	enum class LightEnvParameterSGIX : gl::enum_t {
		LightEnvModeSgix = 0x8407
	};
	enum class FragmentLightModelParameterSGIX : gl::enum_t {
		FragmentLightModelLocalViewerSgix = 0x8408, 
		FragmentLightModelTwoSideSgix = 0x8409, 
		FragmentLightModelAmbientSgix = 0x840A, 
		FragmentLightModelNormalInterpolationSgix = 0x840B
	};
	enum class FragmentLightNameSGIX : gl::enum_t {
		FragmentLight0Sgix = 0x840C, 
		FragmentLight1Sgix = 0x840D, 
		FragmentLight2Sgix = 0x840E, 
		FragmentLight3Sgix = 0x840F, 
	...
	enum class PixelStoreResampleMode : gl::enum_t {
		/* Formerly 0x8430 in SGI specfile */ ResampleDecimateSgix = 0x8430, 
		/* Formerly 0x842E in SGI specfile */ ResampleReplicateSgix = 0x8433, 
		/* Formerly 0x842F in SGI specfile */ ResampleZeroFillSgix = 0x8434
	};
	enum class FogCoordSrc : gl::enum_t {
	...
	enum class TextureUnit : gl::enum_t {
		Texture0 = 0x84C0, 
		Texture1 = 0x84C1, 
		Texture2 = 0x84C2, 
		Texture3 = 0x84C3, 
	...
	enum class FragmentShaderTextureSourceATI : gl::enum_t {
		Texture0 = 0x84C0, 
		Texture1 = 0x84C1, 
		Texture2 = 0x84C2, 
		Texture3 = 0x84C3, 
	...
	enum class CombinerRegisterNV : gl::enum_t {
		Texture0Arb = 0x84C0, 
		Texture1Arb = 0x84C1, 
	...
	enum class UniformBlockPName : gl::enum_t {
	...
	enum class FenceConditionNV : gl::enum_t {
		AllCompletedNv = 0x84F2
	};
	enum class FenceParameterNameNV : gl::enum_t {
		FenceStatusNv = 0x84F3, 
		FenceConditionNv = 0x84F4
	};
	enum class CombinerVariableNV : gl::enum_t {
		VariableANv = 0x8523, 
		VariableBNv = 0x8524, 
		VariableCNv = 0x8525, 
		VariableDNv = 0x8526, 
	...
	enum class PathColor : gl::enum_t {
		PrimaryColorNv = 0x852C, 
		SecondaryColorNv = 0x852D, 
		PrimaryColor = 0x8577
	};
	enum class CombinerMappingNV : gl::enum_t {
	...
	enum class PixelStoreSubsampleRate : gl::enum_t {
		PixelSubsample4444Sgix = 0x85A2, 
		PixelSubsample2424Sgix = 0x85A3, 
		PixelSubsample4242Sgix = 0x85A4
	};
	enum class TextureNormalModeEXT : gl::enum_t {
		PerturbExt = 0x85AE
	};
	enum class VertexArrayPNameAPPLE : gl::enum_t {
		StorageClientApple = 0x85B4, 
		StorageCachedApple = 0x85BE, 
		StorageSharedApple = 0x85BF
	};
	enum class VertexAttribEnum : gl::enum_t {
		VertexAttribArrayEnabled = 0x8622, 
		VertexAttribArraySize = 0x8623, 
		VertexAttribArrayStride = 0x8624, 
		VertexAttribArrayType = 0x8625, 
	...
	enum class ProgramStringProperty : gl::enum_t {
		ProgramStringArb = 0x8628
	};
	enum class VertexAttribEnumNV : gl::enum_t {
		ProgramParameterNv = 0x8644
	};
	enum class VertexAttribPointerPropertyARB : gl::enum_t {
		VertexAttribArrayPointer = 0x8645, 
		VertexAttribArrayPointerArb = 0x8645
	};
	enum class EvalTargetNV : gl::enum_t {
		Eval2DNv = 0x86C0, 
		EvalTriangular2DNv = 0x86C1
	};
	enum class MapParameterNV : gl::enum_t {
		MapTessellationNv = 0x86C2
	};
	enum class MapAttribParameterNV : gl::enum_t {
		MapAttribUOrderNv = 0x86C3, 
		MapAttribVOrderNv = 0x86C4
	};
	enum class ArrayObjectUsageATI : gl::enum_t {
		StaticAti = 0x8760, 
		DynamicAti = 0x8761
	};
	enum class PreserveModeATI : gl::enum_t {
		PreserveAti = 0x8762, 
		DiscardAti = 0x8763
	};
	enum class ArrayObjectPNameATI : gl::enum_t {
		ObjectBufferSizeAti = 0x8764, 
		ObjectBufferUsageAti = 0x8765
	};
	enum class VertexStreamATI : gl::enum_t {
	...
	enum class GetTexBumpParameterATI : gl::enum_t {
		BumpRotMatrixAti = 0x8775, 
		BumpRotMatrixSizeAti = 0x8776, 
		BumpNumTexUnitsAti = 0x8777, 
		BumpTexUnitsAti = 0x8778
	};
	enum class TexBumpParameterATI : gl::enum_t {
		BumpRotMatrixAti = 0x8775
	};
	enum class VertexShaderOpEXT : gl::enum_t {
		OpIndexExt = 0x8782, 
		OpNegateExt = 0x8783, 
		OpDot3Ext = 0x8784, 
		OpDot4Ext = 0x8785, 
	...
	enum class DataTypeEXT : gl::enum_t {
		ScalarExt = 0x87BE, 
		VectorExt = 0x87BF, 
		MatrixExt = 0x87C0
	};
	enum class VertexShaderStorageTypeEXT : gl::enum_t {
		VariantExt = 0x87C1, 
		InvariantExt = 0x87C2, 
		LocalConstantExt = 0x87C3, 
		LocalExt = 0x87C4
	};
	enum class VertexShaderCoordOutEXT : gl::enum_t {
		XExt = 0x87D5, 
		YExt = 0x87D6, 
		ZExt = 0x87D7, 
		WExt = 0x87D8, 
	...
	enum class ParameterRangeEXT : gl::enum_t {
		NormalizedRangeExt = 0x87E0, 
		FullRangeExt = 0x87E1
	};
	enum class VertexShaderParameterEXT : gl::enum_t {
		CurrentVertexExt = 0x87E2, 
		MvpMatrixExt = 0x87E3
	};
	enum class GetVariantValueEXT : gl::enum_t {
		VariantValueExt = 0x87E4, 
		VariantDatatypeExt = 0x87E5, 
		VariantArrayStrideExt = 0x87E6, 
		VariantArrayTypeExt = 0x87E7
	};
	enum class VariantCapEXT : gl::enum_t {
		VariantArrayExt = 0x87E8
	};
	enum class PNTrianglesPNameATI : gl::enum_t {
		PnTrianglesPointModeAti = 0x87F2, 
		PnTrianglesNormalModeAti = 0x87F3, 
		PnTrianglesTesselationLevelAti = 0x87F4
	};
	enum class QueryParameterName : gl::enum_t {
		QueryCounterBits = 0x8864, 
		CurrentQuery = 0x8865
	};
	enum class OcclusionQueryParameterNameNV : gl::enum_t {
		PixelCountNv = 0x8866, 
		PixelCountAvailableNv = 0x8867
	};
	enum class ProgramFormat : gl::enum_t {
		ProgramFormatAsciiArb = 0x8875
	};
	enum class PixelDataRangeTargetNV : gl::enum_t {
		WritePixelDataRangeNv = 0x8878, 
		ReadPixelDataRangeNv = 0x8879
	};
	enum class CopyBufferSubDataTarget : gl::enum_t {
		ArrayBuffer = 0x8892, 
		ElementArrayBuffer = 0x8893, 
		PixelPackBuffer = 0x88EB, 
		PixelUnpackBuffer = 0x88EC, 
	...
	enum class BufferStorageTarget : gl::enum_t {
		ArrayBuffer = 0x8892, 
		ElementArrayBuffer = 0x8893, 
		PixelPackBuffer = 0x88EB, 
		PixelUnpackBuffer = 0x88EC, 
	...
	enum class BufferAccessARB : gl::enum_t {
		ReadOnly = 0x88B8, 
		WriteOnly = 0x88B9, 
		ReadWrite = 0x88BA
	};
	enum class BufferPointerNameARB : gl::enum_t {
		BufferMapPointer = 0x88BD, 
		BufferMapPointerArb = 0x88BD
	};
	enum class BufferUsageARB : gl::enum_t {
		StreamDraw = 0x88E0, 
		StreamRead = 0x88E1, 
		StreamCopy = 0x88E2, 
		StaticDraw = 0x88E4, 
	...
	enum class FragmentShaderConATI : gl::enum_t {
		Con0Ati = 0x8941, 
		Con1Ati = 0x8942, 
		Con2Ati = 0x8943, 
		Con3Ati = 0x8944, 
	...
	enum class FragmentOp1ATI : gl::enum_t {
		MovAti = 0x8961
	};
	enum class FragmentOp2ATI : gl::enum_t {
		AddAti = 0x8963, 
		MulAti = 0x8964, 
		SubAti = 0x8965, 
		Dot3Ati = 0x8966, 
	...
	enum class FragmentOp3ATI : gl::enum_t {
		MadAti = 0x8968, 
		LerpAti = 0x8969, 
		CndAti = 0x896A, 
		Cnd0Ati = 0x896B, 
	...
	enum class SubroutineParameterName : gl::enum_t {
		UniformSize = 0x8A38, 
		UniformNameLength = 0x8A39, 
...
/// </summary>
	...
	enum class ShaderType : gl::enum_t {
		FragmentShader = 0x8B30,
	...
	constexpr char const *to_string(ShaderType const e) {
		switch (e) {
...
/// </summary>
	...
	enum class ContainerType : gl::enum_t {
		ProgramObjectArb = 0x8B40, 
		ProgramObjectExt = 0x8B40
	};
	enum class ShaderParameterName : gl::enum_t {
		ShaderType = 0x8B4F, 
		DeleteStatus = 0x8B80, 
	...
	enum class ShaderBinaryFormat : gl::enum_t {
		SgxBinaryImg = 0x8C0A, 
	...
	enum class TransformFeedbackPName : gl::enum_t {
		TransformFeedbackBufferStart = 0x8C84, 
		TransformFeedbackBufferSize = 0x8C85, 
		TransformFeedbackBufferBinding = 0x8C8F, 
	...
	enum class TransformFeedbackBufferMode : gl::enum_t {
		InterleavedAttribs = 0x8C8C, 
		SeparateAttribs = 0x8C8D
	};
	enum class ProgramInterface : gl::enum_t {
		TransformFeedbackBuffer = 0x8C8E, 
		Uniform = 0x92E1, 
		UniformBlock = 0x92E2, 
		ProgramInput = 0x92E3, 
	...
	enum class ClipControlOrigin : gl::enum_t {
		LowerLeft = 0x8CA1, 
		UpperLeft = 0x8CA2
	};
	enum class FramebufferTarget : gl::enum_t {
		ReadFramebuffer = 0x8CA8, 
		DrawFramebuffer = 0x8CA9, 
		Framebuffer = 0x8D40, 
		FramebufferOes = 0x8D40
	};
	enum class RenderbufferParameterName : gl::enum_t {
	...
	enum class RenderbufferTarget : gl::enum_t {
		Renderbuffer = 0x8D41, 
		RenderbufferOes = 0x8D41
	};
	enum class ProgramStagePName : gl::enum_t {
	...
	enum class PrecisionType : gl::enum_t {
		LowFloat = 0x8DF0, 
		MediumFloat = 0x8DF1, 
		HighFloat = 0x8DF2, 
		LowInt = 0x8DF3, 
	...
	enum class ConditionalRenderMode : gl::enum_t {
		QueryWait = 0x8E13, 
		QueryNoWait = 0x8E14, 
	...
	enum class BindTransformFeedbackTarget : gl::enum_t {
		TransformFeedback = 0x8E22
	};
	enum class QueryCounterTarget : gl::enum_t {
		Timestamp = 0x8E28, 
		TimestampExt = 0x8E28
	};
	enum class ProgramResourceProperty : gl::enum_t {
		NumCompatibleSubroutines = 0x8E4A, 
		CompatibleSubroutines = 0x8E4B, 
		Uniform = 0x92E1, 
		IsPerPatch = 0x92E7, 
	...
	enum class PathCoverMode : gl::enum_t {
		PathFillCoverModeNv = 0x9082, 
		ConvexHullNv = 0x908B, 
		BoundingBoxNv = 0x908D
	};
	enum class InstancedPathCoverMode : gl::enum_t {
		PathFillCoverModeNv = 0x9082, 
		ConvexHullNv = 0x908B, 
		BoundingBoxNv = 0x908D, 
		BoundingBoxOfBoundingBoxesNv = 0x909C
	};
	enum class PathElementType : gl::enum_t {
		Utf8Nv = 0x909A, 
		Utf16Nv = 0x909B
	};
	enum class PathHandleMissingGlyphs : gl::enum_t {
		SkipMissingGlyphNv = 0x90A9, 
		UseMissingGlyphNv = 0x90AA
	};
	enum class PathListMode : gl::enum_t {
		AccumAdjacentPairsNv = 0x90AD, 
		AdjacentPairsNv = 0x90AE, 
		FirstToRestNv = 0x90AF
	};
	enum class AtomicCounterBufferPName : gl::enum_t {
	...
	enum class SyncParameterName : gl::enum_t {
		ObjectType = 0x9112, 
		SyncCondition = 0x9113, 
		SyncStatus = 0x9114, 
		SyncFlags = 0x9115
	};
	enum class SyncCondition : gl::enum_t {
		SyncGpuCommandsComplete = 0x9117
	};
	enum class SyncStatus : gl::enum_t {
		AlreadySignaled = 0x911A, 
		TimeoutExpired = 0x911B, 
		ConditionSatisfied = 0x911C, 
		WaitFailed = 0x911D
	};
	enum class ProgramInterfacePName : gl::enum_t {
		ActiveResources = 0x92F5, 
		MaxNameLength = 0x92F6, 
		MaxNumActiveVariables = 0x92F7, 
		MaxNumCompatibleSubroutines = 0x92F8
	};
	enum class FramebufferParameterName : gl::enum_t {
		FramebufferDefaultWidth = 0x9310, 
		FramebufferDefaultHeight = 0x9311, 
		FramebufferDefaultLayers = 0x9312, 
		FramebufferDefaultSamples = 0x9313, 
	...
	enum class ClipControlDepth : gl::enum_t {
		NegativeOneToOne = 0x935E, 
		ZeroToOne = 0x935F
	};
	enum class TextureLayout : gl::enum_t {
	...
	enum class MemoryObjectParameterName : gl::enum_t {
		DedicatedMemoryObjectExt = 0x9581, 
		ProtectedMemoryObjectExt = 0x959B
	};
	enum class ExternalHandleType : gl::enum_t {
	...
	enum class SemaphoreParameterName : gl::enum_t {
	...
	enum class ShadingRateQCOM : gl::enum_t {
	...
	enum class ShadingRate : gl::enum_t {
	...
	enum class TexStorageAttribs : gl::enum_t {
		SurfaceCompressionExt = 0x96C0, 
	...
	enum class ShadingRateCombinerOp : gl::enum_t {
	...
	enum class HintTargetPGI : gl::enum_t {
		VertexDataHintPgi = 0x1A22A, 
		VertexConsistentHintPgi = 0x1A22B, 
		MaterialSideHintPgi = 0x1A22C, 
		MaxVertexHintPgi = 0x1A22D
